                ...
                <div className="container px-6 py-12 h-full">
                    <div className="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
                        <div className="md:w-8/12 lg:w-6/12 mb-12 md:mb-0">
                            <img src="https://lh3.googleusercontent.com/gg/ANIJZFEUWt7ObYES0Uh6lhZD0Lt0exQOMaP0rYgKzCzjXAgTPLdcaofyIzPfCylGhVk0NYhIWyc-vs1PDF8fRS-0wAZiThEPMz9PQUP7-YWx5cjjEbgVP5EOM4K4TN6Lswejss8slvVv89QtuLMepAazbxYk8L2PrFI-A6yLAYu8WDe7rN3pZDUNtiW-h3J436xq83RtpjHh8aPGjRWEKzlr9C79wVkkRh07BGloMn0sAlNpfcUHKIOQGnKm4K20Kvr6IGu2ChEfjfErO4hzSbn2X26uLOxiuHBYLWet9EeRkKod6TkW5HAOVz7FBa-WXCLwL42zRdRjaZvElvjWzMtAuzts?authuser=1" className="w-full" alt="Phone" />
                        </div>
                            ...
                            <form method='post' onSubmit={handleSubmit}>
                                ...
                                <div className="mb-6">
                                    <input
                                        type="text"
                                        name='name'
                                        className="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-[#975a5e] focus:outline-none"
