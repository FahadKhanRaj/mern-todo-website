        ...
        <div className="text-center">
            ...
            <form className="w-2/5 mx-auto p-5" onSubmit={handleSubmit}>
                <input type="email"
                    ...
                    required
                />
                <button className="p-2 rounded-md shadow-md bg-[#975a5e] text-white px-5 mt-10 disabled:bg-indigo-500" disabled={isLoading}>Reset</button>
            </form>
            {
                message && <div className='mt-10 bg-[#975a5e] mx-auto w-2/5 p-3 rounded-lg shadow-lg text-white text-lg'>
                    <p>
                        {message}
                    </p>
                </div>
